...
describe('ionsToProfile', () => {
  test('Volvic: Ca 13, Mg 9, HCO3 80', () => {
  ...
  test('Evian: Ca 80, Mg 26, HCO3 360', () => {
...
describe('normaliseAlkalinity', () => {
  test('mgL_hco3: passthrough', () => {
    expect(normaliseAlkalinity(80, 'mgL_hco3')).toBe(80)
  })

  test('°KH: 16.4 → ~357 mg/L HCO3', () => {
    // 16.4 * 17.848 / 0.8197 ≈ 357
    expect(normaliseAlkalinity(16.4, 'KH')).toBeCloseTo(357, 0)
  })

  test('mmolL_ks43: 5.52 → ~337 mg/L HCO3', () => {
    // 5.52 * 61.02 ≈ 337
